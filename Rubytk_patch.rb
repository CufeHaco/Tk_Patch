...
sleep(1)
system "sudo apt-get install ruby-all-dev".chomp
sleep(1)
puts "Updating/installing tcl8.6-dev and tk8.6-dev"
system "sudo apt-get install tcl8.6-dev"
system "sudo apt-get install tk8.6-dev"
sleep(1)

 puts "creating softlinks"
system "sudo ln -s /usr/lib/x86_64-linux-gnu/tcl8.6/tclConfig.sh /usr/lib/tclConfig.sh"
system "sudo ln -s /usr/lib/x86_64-linux-gnu/tk8.6/tkConfig.sh /usr/lib/tkConfig.sh"
system "sudo ln -s /usr/lib/x86_64-linux-gnu/libtcl8.6.so.0 /usr/lib/libtcl8.6.so.0"
system "sudo ln -s /usr/lib/x86_64-linux-gnu/libtk8.6.so.0 /usr/lib/libtk8.6.so.0"

  sleep(1)
puts "Installing TK GEM with TCL8.6-dev"
sleep(1)
system "sudo gem install tk -- --with-tcltkversion=8.6 \
